...
print("=" * 70)
print("ðŸš€ STEP 5: TRAINING THE MODEL")
print("=" * 70)
...
def preprocess_function(examples):
    inputs = [example['luganda'] for example in examples]
...
try:
    ...
    print("âœ… BLEU metric loaded")
except:
    print("âš ï¸ BLEU metric not available, using alternative metrics")
    bleu = None
...
print("\\nâœ… Trainer initialized and ready!")
...
print("\\nâ³ Training in progress... (this will take 10-30 minutes on GPU)")
